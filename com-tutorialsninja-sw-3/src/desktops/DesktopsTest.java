...
public class DesktopsTest extends Utility {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder() throws InterruptedException {
     ...
     //   verifyText("Name (Z - A)",By.xpath("//div[@id='content']"));
    ...
    //    Thread.sleep(3000);
     ...
     //   Thread.sleep(30000);
    //    driver.findElement(By.xpath("//div[@id='content']/div[4]/div[3]/div/div[2]/div[2]/button/i/span")).click();
        ...
        driver.findElement(By.linkText("Delivery Date2011-04-22")).getText();
