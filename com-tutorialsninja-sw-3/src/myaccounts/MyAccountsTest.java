...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        selectMyAccountOptions("//div[@class='nav pull-right']/ul[1]/li[2]/ul/li[1]/a");
        Thread.sleep(3000);
        sendTextToElement(By.xpath("//input[@id='input-firstname']"),"brown");
        sendTextToElement(By.xpath("//input[@id='input-lastname']"),"Patel");
        sendTextToElement(By.xpath("//input[@id='input-email']"),"brown29112@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-telephone']"),"06545287952");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() throws InterruptedException {
        ...
        selectMyAccountOptions("//div[@class='nav pull-right']/ul[1]/li[2]/ul/li[2]/a");
        Thread.sleep(3000);
        sendTextToElement(By.xpath("//input[@id='input-email']"),"brown2911@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-password']"),";123456");
